...
const Logo = ({ type }) => {
  return (
    <a
      href="https://the3dkings.io/"
      id="three-d-kings-target"
      target="_blank"
      rel="noreferrer"
    >
      <img
        id={
          type === "mobile" ? "three-d-kings-logo-mobile" : "three-d-kings-logo"
        }
        src={ThreeDKingsLogo}
        alt="3D Kings Logo"
      />
      <img
        id={
          type === "mobile"
            ? "three-d-kings-logo-overlay-mobile"
            : "three-d-kings-logo-overlay"
        }
        src={ThreeDKingsLogo}
        alt="3D Kings Logo"
      />
...
const TopNavBar = ({ isMobile, activePage, setActivePage }) => {
  ...
  const MenuLink = ({ link, text }) => {
    return (
      <Link
        className={activePage === link ? "active" : null}
        to={pageDict[link]}
        id={link}
        onClick={onLinkClick}
      >
  ...
  const links = (
    <>
      ...
      <a href="https://docs.the3dkings.io" target="_blank" rel="noreferrer">
        Read the Docs
      </a>
      ...
      <span className="dropdown">
        ...
        <span className="dropdown-content">
          ...
          <a
            href="https://opensea.io/collection/lazy-butts"
            target="_blank"
            rel="noreferrer"
          >
            Lazy Butts
      ...
      <a href="https://x.com/3DKingsNFT" target="_blank" rel="noreferrer">
        X (@3DKingsNFT)
      </a>
    </>
  );
...
TopNavBar.propTypes = {
  ...
  activePage: PropType.string.isRequired,
